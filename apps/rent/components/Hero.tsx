    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[28px]">
      ...
      <div className="relative z-10 content-sizer py-16 text-center">
        ...
        <div className="flex flex-col items-center">
          <div className="relative flex flex-row flex-wrap items-center justify-center gap-8 sm:gap-12 lg:gap-16 self-center transition-opacity duration-700 max-sm:w-[388px] max-sm:overflow-hidden mb-8">
            {/* Global Coverage */}
            <div className="flex flex-col items-center group cursor-default">
              ...
              <p className="text-white/60 text-xs sm:text-sm">Countries</p>
            </div>
            ...
            <div className="flex flex-col items-center group cursor-default">
              ...
              <p className="text-white/60 text-xs sm:text-sm">IP Addresses</p>
            </div>
            ...
            <div className="flex flex-col items-center group cursor-default">
              ...
              <p className="text-white/60 text-xs sm:text-sm">Uptime SLA</p>
            </div>
            ...
            <div className="flex flex-col items-center group cursor-default">
              ...
              <p className="text-white/60 text-xs sm:text-sm">Anonymous</p>
            </div>
          </div>
          ...
          {/* Feature Checkmarks */}
          <div className="items-center mb-10 text-white">
            <div className="flex items-center p-2">
              <Check className="w-4 h-4" color="orange" />
              <span className="text-[15px] pl-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-4 px-4">
          ...
          <button className="w-full sm:w-auto px-8 sm:px-10 py-3 sm:py-4 text-sm sm:text-[15px] md:text-[16px] font-semibold text-white border-2 border-white/30 rounded-lg hover:border-white/50 transition-all min-w-[160px] sm:min-w-[180px] flex items-center justify-center gap-2">
            <LogInIcon />
            <span className="hidden sm:inline text-[rgb(var(--brand-400))]">
              Sign up now
            </span>
          </button>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 mb-12 sm:mb-16 px-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <span className="text-white/40 text-xs">Accepted:</span>
